  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        I'm a Senior Full Stack Developer with 5+ years of experience building scalable enterprise applications using Node.js, NestJS, React.js, Angular, TypeScript, MongoDB, PostgreSQL, and MySQL. I specialize in backend engineering, system design, microservices, and AI-powered solutions while delivering seamless user experiences and high-quality software products.
      </p>
